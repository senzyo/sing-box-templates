...
注意, `ghp.ci` (以前是 `mirror.ghproxy.com`) 和 `ghproxy.net` 这两个 GitHub 代理服务偶尔会失效。

```
https://ghp.ci/https://raw.githubusercontent.com/MetaCubeX/meta-rules-dat/refs/heads/sing/geo/geosite/category-games.json
```
